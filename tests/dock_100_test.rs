...
fn test_dock_bottom_small() {
    ...
    compare(expected, dock_vertices(100.0, Orientation::Bottom, thickness));
}
...
fn test_dock_left_small() {
    ...
    let br = [-v, -1.0];
    let expected = vec![tr, tl, bl, tr, br, bl];
    compare(expected, dock_vertices(100.0, Orientation::Left, thickness));
}
...
fn test_dock_top_small() {
    ...
    let br = [1.0, -1.0];
    let expected = vec![tr, tl, bl, tr, br, bl];
    compare(expected, dock_vertices(100.0, Orientation::Top, thickness));
}
...
fn test_dock_right_small() {
    ...
    let br = [1.0, -1.0];
    let expected = vec![tr, tl, bl, tr, br, bl];
    compare(expected, dock_vertices(100.0, Orientation::Right, thickness));
}
